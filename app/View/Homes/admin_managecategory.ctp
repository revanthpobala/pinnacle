...
<table>
    ...
    <tr>
        ...
        <td><?php echo $this->Html->link('edit',array('controller'=>'Homes','action'=>'/editcat',$post['Category']['id'])); ?>
         ||<?php  echo $this->Html->link('delete','javascript:void(0);',array('class'=>'del','id'=>'del'.$cnt++,'value'=>$post['Category']['id'])); ?>  
     </tr>
    <?php }endforeach; ?>
    <?php unset($post); ?>
</table>
 <?php echo $this->Html->link('Add Product',array('controller'=>'Homes','action'=>'admin_addcat')); ?>
